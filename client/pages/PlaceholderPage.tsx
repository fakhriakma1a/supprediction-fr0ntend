            ...
            <CardContent className="p-12 text-center">
              ...
              <div className="bg-blue-50 rounded-2xl p-8">
                ...
                <p className="font-poppins text-blue-700 leading-relaxed">
                  This feature is currently under development. Please continue prompting 
                  to help build out the specific functionality you need for this section 
                  of the SUPPrediction system.
                </p>
              </div>
            </CardContent>
          </Card>
